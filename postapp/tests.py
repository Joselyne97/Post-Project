...
class ProjectTestClass(TestCase):
    def setUp(self):
        ...
        self.new_user=User(id=1,username='Jo')
        self.new_profile=Profile(id=2,bio='lionne',profile_pic='default.jpg',full_name='jojo', user=self.new_user, email='joselynejojo740@gmail.com', phone_number='0787753215')
        self.new_project=Project(id=3,title='song',image='default.jpg', user=self.new_user, profile=self.new_profile, description='cool',vote=5,comments='comment it')
...
class CommentTestClass(TestCase):
    def setUp(self):
        ...
        self.new_user=User(id=1,username='Jo')
        self.new_project=Project(id=3,title='song',image='default.jpg', user=self.new_user, description='cool',vote=5,comments='comment it')
